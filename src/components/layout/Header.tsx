...
export function Header({
  ...
  return (
    <header className="fixed top-0 inset-x-0 z-50 w-full border-b border-white/40 bg-white/85 backdrop-blur-2xl shadow-sm dark:border-white/10 dark:bg-slate-950/85 pt-[env(safe-area-inset-top,0px)]">
